...
from PyQt5.QtWidgets import QApplication, QVBoxLayout, QLabel, QWidget, QGridLayout, \
...
# ClassAgeCalculator inherit from QWidget
class AgeCalculator(QWidget):

    def __init__(self):
        # returns original method of QWidget Class
        super().__init__()
